...
contains 
   ...
   subroutine hamiltonian(E,t,U,mu)
      ...
      ! this subroutine calculates the all the hamiltonian sub matrices and finds their eigenvalues and eigenvectors. 
      implicit none
      ...
      ! find the eigenvectors and eigenvalues using LAPACK
      LWORK = 30
      allocate(WORK(30))
   ...
   subroutine transformations()
      ...
      ! this subroutines makes the pre calculated PES and IPES lookup tables.
      ...
      sites: do j=1,3  ! calculating the IPES matrices by making them the opposite of the PES (if state "A" photo emmits to "B", "B" must inverse photo emmit to "A")
         do i=1,64
