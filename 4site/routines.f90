...
!term that are off the main diagonal
H11(1,3) = t;    H11(1,10) = -t;  H11(1,13) = t;  H11(1,14) = t
H11(2,4) = t;    H11(2,9) = -t;  H11(2,13) = -t; H11(2,14) = -t
H11(3,5) = t;    H11(3,7) = t;   H11(3,12) = -t
H11(4,6) = t;    H11(4,8) = t;   H11(4,11) = -t
H11(5,9) = t;    H11(5,13) = t; H11(5,16) = t
H11(6,10) = t;   H11(6,13) = -t; H11(6,16) = -t
H11(7,9) = t;    H11(7,14) = t; H11(7,15) = t
H11(8,10) = t;   H11(8,14) = -t; H11(8,15) = -t
H11(9,11) = t
H11(10,12) = t
H11(11,15) = t;  H11(11,16) = t
H11(12,15) = -t; H11(12,16) = -t

!term that are on the main diagonal
...
H21(1,4) = t;    H21(1,11) = t;   H21(1,14) = t;  H21(1,16) = t
H21(2,5) = t;    H21(2,12) = t;   H21(2,14) = -t; H21(2,15) = t; H21(2,16) = -t; H21(2,19) = t
H21(3,6) = t;    H21(3,10) = t;   H21(3,15) = -t; H21(3,19) = -t
...
H21(12,21) = -t;  H21(12,23) = -t
H21(13,14) = -t; H21(13,15) = t
H21(14,21) = t
H21(15,17) = t
...
H31(1,5) = t; H31(1,7) = t;  H31(1,10) = t; H31(1,16) = t
H31(2,7) = -t; H31(2,9) = t; H31(2,10) = -t; H31(2,12) = t
H31(3,9) = -t;  H31(3,11) = t; H31(3,12) = -t; H31(3,14) = t
H31(4,5) = -t; H31(4,11) = -t; H31(4,14) = -t; H31(4,16) = -t
H31(5,6) = -t; H31(5,8) = t
...
H13(1,5) = -t; H13(1,7) = -t;  H13(1,10) = -t; H13(1,16) = -t
H13(2,7) = t; H13(2,9) = -t; H13(2,10) = t; H13(2,12) = -t
H13(3,9) = t;  H13(3,11) = -t; H13(3,12) = t; H13(3,14) = -t
H13(4,5) = t; H13(4,11) = t; H13(4,14) = t; H13(4,16) = t
H13(5,6) = -t; H13(5,8) = t
H13(6,7) = -t; H13(6,9) = t; H13(6,14) = -t
H13(7,15) = -t
H13(8,9) = -t; H13(8,10) = t; H13(8,11) = t
H13(10,13) = t
H13(11,13) = t
H13(12,13) = -t; H13(12,15) = t
H13(13,16) = t
H13(14,15) = -t
H13(15,16) = -t

H13(1,1) = E(1) + E(2) + E(3) + E(4); H13(2,2) = H13(1,1); H13(3,3) = H13(1,1); H13(4,4) = H13(1,1)
H13(5,5) = 2*E(1) + E(2) + E(3) + U; H13(6,6) = E(1) + 2*E(2) + E(3) + U; H13(7,7) = E(1) + E(2) + 2*E(3) + U
H13(8,8) = 2*E(1) + E(2) + E(4) + U; H13(9,9) = E(1) + 2*E(2) + E(4) + U; H13(10,10) = E(1) + E(2) + 2*E(4) + U
H13(11,11) = 2*E(1) + E(3) + E(4) + U; H13(12,12) = E(1) + 2*E(3) + E(4) + U; H13(13,13) = E(1) + E(3) + 2*E(4) + U
H13(14,14) = 2*E(2) + E(3) + E(4) + U; H13(15,15) = E(2) + 2*E(3) + E(4) + U; H13(16,16) = E(2) + E(3) + 2*E(4) + U
...
H22(1,7) = t; H22(1,15) = t; H22(1,21) = t; H22(1,29) = t
H22(2,8) = t; H22(2,11) = t; H22(2,15) = -t; H22(2,17) = t
H22(2,19) = t; H22(2,21) = -t; H22(2,25) = t; H22(2,30) = t
H22(3,11) = -t; H22(3,17) = -t; H22(3,20) = t; H22(3,26) = t
H22(4,12) = t; H22(4,18) = t; H22(4,19) = -t; H22(4,25) = -t
H22(5,7) = -t; H22(5,12) = -t; H22(5,16) = t; H22(5,18) = -t
H22(5,20) = -t; H22(5,22) = t; H22(5,26) = -t; H22(5,29) = -t
H22(6,8) = -t; H22(6,16) = -t; H22(6,22) = -t; H22(6,30) = -t
H22(7,9) = -t; H22(7,13) = t; H22(7,31) = t; H22(7,32) = t
H22(8,10) = -t; H22(8,14) = t; H22(8,31) = -t; H22(8,32) = -t
H22(9,11) = -t; H22(9,15) = t; H22(9,26) = -t
H22(10,12) = -t; H22(10,16) = t; H22(10,25) = -t
H22(11,28) = -t; H22(11,32) = t; H22(11,34) = t
H22(12,27) = -t; H22(12,32) = -t; H22(12,34) = -t
H22(13,15) = -t; H22(13,18) = t; H22(13,19) = t
H22(14,16) = -t; H22(14,17) = t; H22(14,20) = t
H22(15,31) = t; H22(15,35) = t
H22(16,31) = -t; H22(16,35) = -t
H22(17,23) = t; H22(17,33) = t; H22(17,35) = t
H22(18,24) = t; H22(18,33) = -t; H22(18,35) = -t
H22(19,24) = t; H22(19,32) = t; H22(19,33) = t
H22(20,24) = t; H22(20,32) = -t; H22(20,33) = -t
H22(21,24) = t; H22(21,27) = t; H22(21,32) = t; H22(21,36) = t
H22(22,24) = -t; H22(22,28) = t; H22(22,32) = -t; H22(22,36) = -t
H22(23,29) = t
H22(24,30) = t
H22(25,27) = -t; H22(25,34) = t; H22(25,35) = t
H22(26,28) = -t; H22(26,34) = -t; H22(26,35) = -t
H22(27,29) = -t
H22(28,30) = -t
...
H32(1,4) = -t; H32(1,12) = -t; H32(1,14) = t; H32(1,17) = t
H32(2,5) = -t; H32(2,10) = -t; H32(2,14) = -t; H32(2,16) = t; H32(2,17) = -t; H32(2,19) = t
H32(3,6) = -t; H32(3,11) = -t; H32(3,16) = -t; H32(3,19) = -t
H32(4,7) = -t; H32(4,13) = -t; H32(4,15) = t; H32(4,18) = t; H32(4,23) = -t
H32(5,8) = -t; H32(5,15) = -t; H32(5,18) = -t
H32(6,9) = -t; H32(6,13) = t; H32(6,23) = t
H32(7,10) = -t; H32(7,14) = -t; H32(7,24) = -t
H32(8,11) = -t; H32(8,19) = t; H32(8,22) = t
H32(9,12) = -t; H32(9,14) = t; H32(9,19) = t; H32(9,22) = -t; H32(9,24) = t
H32(10,18) = t; H32(10,21) = t
H32(11,18) = -t; H32(11,20) = t; H32(11,21) = -t; H32(11,23) = t
H32(12,20) = -t; H32(12,23) = -t
H32(13,14) = -t; H32(13,16) = t
H32(14,15) = -t
H32(15,22) = t
H32(16,18) = -t
...
H33(1,3) = -t; H33(1,10) = t; H33(1,13) = t; H33(1,14) = t
H33(2,4) = -t; H33(2,9) = t; H33(2,13) = -t; H33(2,14) = -t
H33(3,5) = -t; H33(3,7) = -t; H33(3,12) = t
H33(4,6) = -t; H33(4,8) = -t; H33(4,11) = t
H33(5,9) = -t; H33(5,14) = t;  H33(5,15) = t
H33(6,10) = -t; H33(6,14) = -t;  H33(6,15) = -t
H33(7,9) = -t; H33(7,13) = t; H33(7,16) = t
H33(8,10) = -t; H33(8,13) = -t; H33(8,16) = -t
H33(9,11) = -t
H33(10,12) = -t
