...
real :: inner_product_up(32), inner_product_down(32)
...
do i=1,16
   ...
   LDOS1(i,2) = (inner_product_down(i) + inner_product_down(i))*0.5
end do
...
do i=17,32
   ...
   LDOS1(i,1) = omega(i) - omega_ground
   LDOS1(i,2) = (inner_product_down(i) + inner_product_down(i))*0.5   !average the up spin and down spin magnitudes
end do

do i=1,32
   write(*,*), LDOS1(i,1), LDOS1(i,2)
end do
end program main
