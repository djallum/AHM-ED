...
<body>
<h1>2 Site Model</h1>
<p> The files contained in the directory are for the simulations of the Anderson-Hubbard model using an ensemble of 2 site systems. The program will calculate the density of states (DOS), generalized inverse participaion ratio (GIPR) and the filling of the DOS.</p> 
